...
export const metadata: Metadata = {
  ...
  twitter: {
    ...
    // Twitter image auto-generated via opengraph-image.tsx
  },
  alternates: {
...
const jsonLd = {
  ...
  "@graph": [
    ...
    {
      "@type": "WebPage",
      "@id": "https://counselstack.io/#webpage",
      "url": "https://counselstack.io",
      "name": "CounselStack - Compare Legal Practice Management Software",
      "description": "Independent, unbiased comparisons of legal practice management software for law firms.",
      "isPartOf": { "@id": "https://counselstack.io/#website" },
      "primaryImageOfPage": {
        "@type": "ImageObject",
        "url": "https://counselstack.io/og-image.png"
      }
    },
